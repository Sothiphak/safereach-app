...
enum ServiceType {
  ...
  hospital('Hospital', Icons.local_hospital, Color(0xFFFF3B30)), // Vibrant Vermilion
  fire('Fire', Icons.local_fire_department, Color(0xFFFF9500)), // Alert Orange
  ambulance('Ambulance', Icons.airport_shuttle, Color(0xFF8E44AD)), // Vibrant Purple
  women('Women Help', Icons.woman, Color(0xFFFF2D55)), // System Pink
  disaster('Disaster Relief', Icons.crisis_alert, Color(0xFF64748B)); // Slate Gray
